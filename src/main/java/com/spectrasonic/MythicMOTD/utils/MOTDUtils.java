...
public class MOTDUtils {
    ...
    // Ancho estándar de línea para centrar (aproximadamente el ancho típico de la pantalla de servidor)
    private static final int LINE_WIDTH = 40;
    
    /**
     * Procesa una línea del MOTD aplicando MiniMessage y centrado de texto
     * @param line La línea del MOTD a procesar
     * @return Componente procesado
     */
    ...
    /**
     * Procesa las etiquetas de centrado <center> o <c> en una línea
     * @param line La línea a procesar
     * @return Línea con el texto centrado convertido a espacios
     */
    ...
    /**
     * Centra el texto agregando espacios al inicio
